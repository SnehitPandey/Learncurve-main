...
function findUnused(baseDir, entryPoints) {
  ...
  for (const file of allFiles) {
    ...
    if (baseName === 'index') continue; // too generic to check easily
...
try {
  const frontendUnused = findUnused('d:/Programming/fullstack/learncurve/learncurve-main/src', ['main.jsx', 'index.js', 'App.jsx']);
